...
const AboutCardA: React.FC<AboutCardAProps> = ({
  number,
  title,
  text,
  img,
  ...
  return (
    ...
    >
      {/* Project Number */}
      <div className="absolute top-6 left-4 bg-pink-500 text-white text-sm font-bold rounded-full h-10 w-10 flex items-center justify-center shadow-lg z-10">
        {number}
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex-1 flex flex-col text-center md:text-start gap-4 md:gap-6">
          <h3 className="text-xl md:text-2xl font-bold  text-pink-400">
            {title}
          </h3>
